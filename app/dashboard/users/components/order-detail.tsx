        ...
        >
          <div className="flex items-center justify-between px-3.5">
            ...
            <div className="flex items-center gap-3">
              <Badge
                className={`${getStatusColor(order.status)} border px-4 py-1.5 text-sm font-semibold`}
                style={{ backgroundColor: "#def5e4" }}
              >
                {order.status}
              </Badge>
        ...
        <div className="overflow-y-auto max-h-[calc(90vh-120px)] px-6 pb-6">
                ...
                >
                  <div className="relative w-24 h-24 flex-shrink-0">
                    <Image
                      ...
                      alt={item.productDetails?.images[0]}
                      fill
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {order.instruction && (
                <div
                  className="col-span-1 md:col-span-2 p-4 rounded-lg border"
                  style={{ backgroundColor: "#def5e4", borderColor: "#c5ecd3" }}
                >
                  <div className="flex items-start gap-3">
                ...
                <div className="relative w-16 h-16 flex-shrink-0">
                  {order?.user?.profilePicture ? (
                    <img
                      ...
                      alt={order.user.name}
                      className="rounded-full w-full h-full  border-2 border-white shadow-md"
                    />
                  ) : (
                ...
                <div className="flex items-start justify-between mb-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="relative w-14 h-14 flex-shrink-0">
                      {order.rider.profilePicture ? (
                        <Image
                          src={order.rider.profilePicture}
